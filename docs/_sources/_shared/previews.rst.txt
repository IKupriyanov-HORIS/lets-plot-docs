...
.. |correlation_plot-nbviewer| image:: _static/images/previews/correlation_plot.png
...
.. |facets-nbviewer| image:: _static/images/previews/facets.png
    :target: https://nbviewer.jupyter.org/github/JetBrains/lets-plot/blob/master/docs/examples/jupyter-notebooks/facets.ipynb
.. |formatting_axes-nbviewer| image:: _static/images/previews/formatting_axes_etc.png
...
.. |geocoding_examples-nbviewer| image:: _static/images/previews/geocoding_examples.png
...
.. |geocoding_reference-nbviewer| image:: _static/images/previews/geocoding_reference.png
...
.. |geom_smooth-nbviewer| image:: _static/images/previews/geom_smooth.png
...
.. |kotlin_isl-nbviewer| image:: _static/images/previews/geopandas_kotlin_isl.png
...
.. |geopandas_naturalearth-nbviewer| image:: _static/images/previews/geopandas_naturalearth.png
...
.. |ggbunch-nbviewer| image:: _static/images/previews/ggbunch.png
    :target: https://nbviewer.jupyter.org/github/JetBrains/lets-plot/blob/master/docs/examples/jupyter-notebooks/ggbunch.ipynb
.. |image_matrix-nbviewer| image:: _static/images/previews/image_matrix.png
...
.. |label_format-nbviewer| image:: _static/images/previews/label_format.png
...
.. |california_housing-nbviewer| image:: _static/images/previews/map_california_housing.png
...
.. |map_US_household-nbviewer| image:: _static/images/previews/map_US_household_income.png
...
.. |mapping_US_household-kaggle| image:: _static/images/previews/mapping-us-household-income.png
    :target: https://www.kaggle.com/alshan/mapping-us-household-income
.. |airbnb_boston-datalore| image:: _static/images/previews/plotting-airbnb-prices-boston.png
    :target: https://datalore.jetbrains.com/view/notebook/eifzdh96VYuNrcjuOpYPYr
.. |sampling_groups-nbviewer| image:: _static/images/previews/sampling_groups.png
...
.. |sampling_pick-nbviewer| image:: _static/images/previews/sampling_pick.png
...
.. |sampling_random-nbviewer| image:: _static/images/previews/sampling_random.png
...
.. |sampling_stratified-nbviewer| image:: _static/images/previews/sampling_stratified.png
...
.. |sampling_systematic-nbviewer| image:: _static/images/previews/sampling_systematic.png
...
.. |sampling_vertex-nbviewer| image:: _static/images/previews/sampling_vertex.png
...
.. |scatter_matrix-nbviewer| image:: _static/images/previews/scatter_matrix.png
...
.. |basemaps-kaggle| image:: _static/images/previews/the-gallery-of-basemaps.png
    :target: https://www.kaggle.com/alshan/the-gallery-of-basemaps
.. |tooltip-nbviewer| image:: _static/images/previews/tooltip_config.png
...
.. |airport-kaggle| image:: _static/images/previews/visualization-of-airport-data-on-map.png
    :target: https://www.kaggle.com/alshan/visualization-of-airport-data-on-map
.. |titanic-kaggle| image:: _static/images/previews/visualization-of-the-titanic-s-voyage.png
    :target: https://www.kaggle.com/alshan/visualization-of-the-titanic-s-voyage


.. Full Size Previews (1024x768 px)

.. |formatting_axes-full-nbviewer| image:: _static/images/previews/formatting_axes_etc_full.png
    :target: https://nbviewer.jupyter.org/github/JetBrains/lets-plot/blob/master/docs/examples/jupyter-notebooks/formatting_axes_etc.ipynb
.. |geom_smooth-full-nbviewer| image:: _static/images/previews/geom_smooth_full.png
    :target: https://nbviewer.jupyter.org/github/JetBrains/lets-plot/blob/master/docs/examples/jupyter-notebooks/geom_smooth.ipynb
.. |kotlin_isl-full-nbviewer| image:: _static/images/previews/geopandas_kotlin_isl_full.png
    :target: https://nbviewer.jupyter.org/github/JetBrains/lets-plot/blob/master/docs/examples/jupyter-notebooks/geopandas_kotlin_isl.ipynb
.. |airport-full-kaggle| image:: _static/images/previews/visualization-of-airport-data-on-map_full.png
    :target: https://www.kaggle.com/alshan/visualization-of-airport-data-on-map